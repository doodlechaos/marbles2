...
declare module '$env/static/private' {
	...
	export const IS_ON_MY_LOCAL_PC: string;
	export const JAVA_HOME: string;
	export const LANG: string;
	export const LOCALAPPDATA: string;
	export const LOGONSERVER: string;
	export const MAIN_BOT_CHANNEL_ID: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		IS_ON_MY_LOCAL_PC: string;
		JAVA_HOME: string;
		LANG: string;
		LOCALAPPDATA: string;
		LOGONSERVER: string;
		MAIN_BOT_CHANNEL_ID: string;
