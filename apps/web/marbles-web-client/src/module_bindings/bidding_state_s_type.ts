...
export const BiddingStateS = {
  ...
  */
  ...
  serialize(writer: __BinaryWriter, value: BiddingStateS): void {
    __AlgebraicTypeValue.serializeValue(writer, BiddingStateS.getTypeScriptAlgebraicType(), value);
  },

  deserialize(reader: __BinaryReader): BiddingStateS {
    return __AlgebraicTypeValue.deserializeValue(reader, BiddingStateS.getTypeScriptAlgebraicType());
  },

}

export default BiddingStateS;
