...
export const BidTimeS = {
  ...
  */
  ...
  serialize(writer: __BinaryWriter, value: BidTimeS): void {
    __AlgebraicTypeValue.serializeValue(writer, BidTimeS.getTypeScriptAlgebraicType(), value);
  },

  deserialize(reader: __BinaryReader): BidTimeS {
    return __AlgebraicTypeValue.deserializeValue(reader, BidTimeS.getTypeScriptAlgebraicType());
  },

}

export default BidTimeS;
